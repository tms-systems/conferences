...
function appendEvent( event ) {
  ...
  if ( eventEndDate.getDate() ) {
    ...
    while ( eventEndDate > date ) {
      ...
      dateElement.removeClass('no-event').append('<div class="event multi-days following-days" style="background: ' + event.hexcolor + '" title=""><a target="_blank" href="' + event.tickets + '"></a></div>')
    }
  }
