...
function appendEvent( event ) {
  ...
  var eventElement   = $('<div class="event"><a target="_blank" href="' + event.s + '"></a></div>')
  ...
  if ( eventEndDate.getDate() ) {
    ...
    while ( eventEndDate > date ) {
      ...
      dateElement.removeClass('no-event').append('<div class="event multi-days following-days" style="border:1px solid ' + event.hexcolor + '"><a target="_blank" href="' + event.tickets + '"></a></div>')
    }
  }
