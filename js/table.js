...
function addMonthMenu() {
  ...
  $('.month-table').each(function(_, table) {
    ...
    $('#agenda').append('<a class="agenda-rows">' + event.name + '</a>')
  })
...
function appendEvent( event ) {
  ...
  var eventElement   = $('<div class="event"><a target="_blank" href="' + event.tickets + '"></a></div>')
  ...
  if ( eventEndDate.getDate() ) {
    ...
    while ( eventEndDate > date ) {
      ...
      dateElement.removeClass('no-event').append('<div class="event multi-days following-days" title="' + event.name + '"><a target="_blank" href="' + event.tickets + '">wut</a></div>')
    }
  }
